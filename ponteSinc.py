...
try:
	...
	print "iteracoes por minuto : " + str (int(1000.0/(total/float(iteracoes)))) + " hz"
	print "iter. por min. Worked: " + str (int(1000.0/(total/float(IteracoesROS)))) + " hz"
	print "--------------------------------"
	tempo = []
	grafico = {}
	maxvalue = 0
